<?php
/** @var array $attributes Validated block attributes. @var string $content Rendered children. */
...
echo \ZMP\Blocks\Blocks\Section::render( $attributes, $content ); // Escaping is owned by the renderer.
